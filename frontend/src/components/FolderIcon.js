      ...
      <g id="_3_petitdossier">
        <g id="folder-icon" transform="translate(82 99)">
          <linearGradient
            ...
            x2="-85.9687"
            y2="-61.4231"
            gradientTransform="matrix(32.0002 0 0 -26 2686.0166 -1669)"
          >
            <stop offset="0" stopColor="#F7D8AF" />
            <stop offset="1" stopColor="#FAD19A" />
          </linearGradient>
          <path
            id="folder"
            fill="url(#folder_1_)"
            d="M-52.2-94.8h-8.9c-0.4,0-0.8-0.2-1.1-0.5l-2.3-2.3c-0.3-0.3-0.7-0.5-1.1-0.5h-12.1
       ...
       C-49-93.3-50.4-94.7-52.2-94.8C-52.2-94.8-52.2-94.8-52.2-94.8z"
          ...
          <path
            id="people"
            fill="#E2AC5F"
            d="M-60.5-78c0.2-0.6,0.2-1.2-0.1-1.7l-1.1-2h1.6c0.9,0,1.8,0.4,2.2,1.2l0.8,1.4
